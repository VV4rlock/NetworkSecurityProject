import random
import math
from gmpy2 import mpz, isqrt, invert, is_prime,powmod,jacobi
...
class CryptoObject():
    ...
    def get_public_g_p(self,key_length=1024):
        p=self.gen_big_prime(key_length)
        #while True:
        #    if is_prime((p-1)//2):
        #        break
        #    else:
...
if __name__=="__main__":
    ...
    print(crypto_object.get_public_g_p(1024))
